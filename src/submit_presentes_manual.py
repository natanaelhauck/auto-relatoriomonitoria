"""Manual attendance submission flow."""
...
def submit_presentes_manual(
    ...
    """Submit present students from the optional SHEET_PRESENTES tab."""
    settings = load_sheets_settings()
    return run_submission(
        sheet_name=settings.sheet_presentes,
...
def main() -> None:
    """CLI entry point."""
    parser = build_parser("Envia presentes manuais para o Google Forms.")
    args = parser.parse_args()
    sys.exit(
        submit_presentes_manual(
